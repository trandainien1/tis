...
class TIS:
    ...
    def __call__(self, x, class_idx=None):
        ...
        with torch.no_grad():
            ...
            print('[DEBUG] After generating binary masks, first mask indices shape: ', mask_indices_list[0].shape)
    ...
    def generate_saliency(self, x, scores, mask_list):
        ...
        print('[DEBUG] scored masks - ', scored_masks.shape)
        print('[DEBUG] raw_saliency - ', raw_saliency.shape)
